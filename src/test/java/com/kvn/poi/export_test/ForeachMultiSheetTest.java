...
*/
public class ForeachMultiSheetTest {
	...
	public static void main(String[] args) throws Exception {
		...
		List list2 = Lists.newArrayList(order2);
		rootObjectMap.put("list", list);
		rootObjectMap.put("list2", list2);
		OutputStream des = new FileOutputStream("E:\\rlt\\test.xlsx");
		InputStream is = ForeachMultiSheetTest.class.getClassLoader().getResourceAsStream("template/01_Template_foreach_multiSheet.xlsx");
